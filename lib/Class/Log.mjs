...
export default class Log {
  ...
  /** @static @function file(filename)
    * Redirects standard output to file specified by file name
  ...
  static log = function(data, type = 'debug') {
    if(!this.default.suppressType.includes(data.type || type) && !this.default.suppressSource.includes(data.source)) {
