/** Handler module {Router} parses the server request and returns parsed data. This data defines which
  * controller, model, and view are called, based on predefined routes.
  *
