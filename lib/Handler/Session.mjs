  ...
  handler(request, response) {
    ...
    return new Promise((resolve, reject) => {
      if(this.has('sessionId')) {
        ...
        response.setHeader('Set-Cookie', Namespace.Cookie.serialize({ sessionId: this.get('sessionId') }));
        ...
        // Set cookie sessionId
        response.setHeader('Set-Cookie', Namespace.Cookie.serialize({ sessionId: data.sessionId }));
